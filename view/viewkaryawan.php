...
<body>
  ...
  <table class="table table-bordered" class="table" border="2" cellspacing="0" cellpadding="5">
    <thead>
      <tr>
        ...
        <th style="text-align:center">
          <h5>No. HP Karyawan</h5>
        </th>
        <th colspan="2" style="text-align:center">
          <a href="../insert/insertkaryawan.php"><button type="button" class="btn btn-outline-success">INSERT DATA</button></a>
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td style="text-align:center"><?php echo $row['namakaryawan'] ?></td>
          <td style="text-align:center"><?php echo $row['alamat'] ?></td>
          <td style="text-align:center"><?php echo $row['telpon'] ?></td>

          <td style="text-align:center"><a href="../delete/deletekaryawan.php?idkaryawan=<?php echo $row['idkaryawan']; ?>"><button type="button" class="btn btn-outline-danger">DELETE</button></a></td>
          
          <td style="text-align:center"><a href="../update/updatekaryawan.php?idkaryawan=<?php echo $row['idkaryawan']; ?>"><button type="button" class="btn btn-outline-info">UPDATE</button></a></td>
        </tr>
      <?php
      }
      ?>

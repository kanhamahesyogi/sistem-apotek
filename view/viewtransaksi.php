        ...
        <thead>
            <tr>
                ...
                <th colspan="2" style="text-align:center">
                    <a href="../insert/inserttransaksi.php?idtransaksi"><button type="button" class="btn btn-outline-success">INSERT DATA</button></a>
            ...
            ?>
                <center>
                    <tr>
                        ...
                        <td style="text-align:center"><?php echo $row['idkasir'] ?></td>
                        ...
                        <td style="text-align:center"><a href="../delete/deletetransaksi.php?idtransaksi=<?php echo $row['idtransaksi']; ?>"><button type="button" class="btn btn-outline-danger">DELETE</button></a></td>
                        <td style="text-align:center"><a href="../update/updatetransaksi.php?idtransaksi=<?php echo $row['idtransaksi']; ?>"><button type="button" class="btn btn-outline-info">UPDATE</button></a></td>

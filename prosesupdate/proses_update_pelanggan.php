...
if ($buktifotoresep !="") {
    ...
    $nama_gambar_baru       = $buktifotoresep;
        ...
        $query = "UPDATE tb_pelanggan SET idpelanggan = '$idpelanggan',namalengkap='$namalengkap',alamat='$alamat',telp='$telp',usia='$usia',buktifotoresep='$nama_gambar_baru'";
    ...
    $query = "UPDATE tb_pelanggan SET idpelanggan = '$idpelanggan',namalengkap='$namalengkap',alamat='$alamat',telp='$telp',usia='$usia',buktifotoresep='$buktifotoresep'";
    $query .= "WHERE idpelanggan = '$idpelanggan'";
    $result = mysqli_query($koneksi, $query);

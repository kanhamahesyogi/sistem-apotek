...
<center>
    ...
    <table class="mt-3" cellpadding="10" margin="auto">
            <tr>
        ...
        <div class="container">
            ...
            <a href="../CoolAdmin-master/index_transaksi.php"><input type="submit" class="btn btn-warning mt-3" value="Lihat Semua Transaksi"></a>
    ...
    <!-- <br>
        ...
        <div class="form-floating col-20 balik">
            <a href="../CoolAdmin-master/index_transaksi.php"><button type="button" class="btn btn-info">BACK</button></a>
        </div>
    </div>
    </form>
</body>

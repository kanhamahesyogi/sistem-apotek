    ...
    <table class="table table-bordered" border="2" align="center" style="margin: 0px auto" ;>
        ...
        <thead>
            <tr>
                ...
                <th style="text-align:center">
                    <h5>No. HP Pelanggan </h5>
                </th>
                <th style="text-align:center">
                    <h5>Usia</h5>
                </th>
                <th style="text-align:center">
                    <h5>Bukti Foto Resep</h5>
                </th>
                </th>
                <th colspan="2" style="text-align:center">
                    <a href="../insert/insertpelanggan.php?id_pelanggan"><button type="button" class="btn btn-outline-success">INSERT DATA</button></a>
            ...
            ?>
                <center>
                    <tr>
                        ...
                        <td style="text-align:center"><?php echo $row['namalengkap'] ?></td>
                        <td style="text-align:center"><?php echo $row['alamat'] ?></td>
                        <td style="text-align:center"><?php echo $row['telp'] ?>

                        </td>
                        <td style="text-align:center"><?php echo $row['usia'] ?></td>
                        <td style="text-align:center"><?= "<img src='../simpanfoto/" . $row['buktifotoresep'] . "'style='width:150px; height:150px;'>" ?></td>
                        
                        <td style="text-align:center"><a href="../delete/deletepelanggan.php?idpelanggan=<?php echo $row['idpelanggan']; ?>" onclick="return confirm('anda yakin menghapus data ini?')"><button type="button" class="btn btn-outline-danger">DELETE</button></a></td>

                        <td style="text-align:center"><a href="../update/updatepelanggan.php?idpelanggan=<?php echo $row['idpelanggan']; ?>"><button type="button" class="btn btn-outline-info">UPDATE</button></a></td>

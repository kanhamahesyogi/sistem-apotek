...
<body >
  ...
  <table class="table" border="5" align="center" style="margin:auto" ;>
    ...
    <thead>
      <tr>
        ...
        <a href="../insert/insertobat.php?idobat"><button type="button" class="btn btn-outline-success">INSERT DATA</button></a>
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td style="text-align:center"> <a href="../delete/deleteobat.php?idobat=<?php echo $row['idobat']; ?>"><button type="button" class="btn btn-outline-danger">DELETE</button></a></td>
          <td style="text-align:center"> <a href="../update/updateobat.php?idobat=<?php echo $row['idobat']; ?>"><button type="button" class="btn btn-outline-info">UPDATE</button></a></td>
        </tr>
      <?php
      }
      ?>

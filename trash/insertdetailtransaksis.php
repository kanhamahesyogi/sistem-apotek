...
$query_pelanggan = mysqli_query($koneksi, "SELECT namalengkap FROM tb_pelanggan WHERE idpelanggan='$idpelanggan'");
...
<tbody>
        ...
        <center>
            <tr>
                ...
                <td style="text-align:center"><?php echo $row_pelanggan['namalengkap'] ?></td>
                <td style="text-align:center"><?php echo $row['kategoripelanggan'] ?></td>
                <td style="text-align:center"><?php echo $row_karyawan['namakaryawan'] ?></td>
            </tr>
        </center>
    <?php
    }

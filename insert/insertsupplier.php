...
<body>
    ...
    <br>
<center><H2>TABEL SUPPLIER</H2></center>
<br>

    <table>
        <form action="../prosesinsert/proses_insert_supplier.php" method="post">
<br>
            ...
            <div class="row justify-content-center">
                <div class="form-floating col-4">
                    <div class="coba">
                        ...
                        <input type="text" class="form-control" cols="2" id="exampleFormControlInput1" placeholder="Kimia Farma.." name="perusahaan">
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="form-floating col-4">
                    <div class="coba">
                        ...
                        <input type="text" class="form-control" cols="2" id="exampleFormControlInput1" placeholder="Keterangan.." name="keterangan">
                    </div>
                </div>
            </div>

...
<body>
    ...
    <br>
<center><H2>TABEL KARYAWAN</H2></center>
<br>

    <table>
        <form action="../prosesinsert/proses_insert_karyawan.php" method="post">
<br>
            ...
            <div class="row justify-content-center">
                <div class="form-floating col-4">
                    <div class="coba">
                        ...
                        <input type="text" class="form-control" cols="2" id="exampleFormControlInput1" placeholder="Made.." name="namakaryawan">
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="form-floating col-4">
                    <div class="coba">
                        ...
                        <input type="text" class="form-control" cols="2" id="exampleFormControlInput1" placeholder="081xx.." name="telpon">
                    </div>
                </div>
            </div>
